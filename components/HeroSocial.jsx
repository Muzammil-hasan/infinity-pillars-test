...
const HeroSocial = () => {
	return (
		<div className='hero__social'>
			<a href='/' className='portfolio_button_icon portfolio_button_icon--gmail'>
				<span>
			...
			{/* <a href='/' className='portfolio_button_icon portfolio_button_icon--linkedin'>
			...
			<a href='/' className='portfolio_button_icon portfolio_button_icon--github'>
